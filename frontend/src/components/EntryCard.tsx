    ...
    <div className="card">
      ...
      <div className="flex items-center justify-between text-xs text-warm-gray mt-4">
        ...
        <div className="flex gap-2">
          <button>
            <svg
              className="p-1.5 pr-3 pl-3.5 rounded-md bg-neutral-100 cursor-pointer hover:bg-blue-100 hover:fill-blue-800 transition"
          ...
          <button aria-label="delete" onClick={handleDelete}>
            <svg
              className="p-1.5 pr-3 pl-3.5 rounded-md bg-neutral-100 cursor-pointer hover:bg-red-100 hover:fill-red-800 transition"
              xmlns="http://www.w3.org/2000/svg"
              height="32px"
              viewBox="0 -960 960 960"
              width="48px"
